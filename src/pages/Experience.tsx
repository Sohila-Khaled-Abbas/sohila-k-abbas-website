...
const Experience = () => {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO
        title="Professional Experience — Sohila Khaled Abbas"
        description="Explore the professional work history and track record of Sohila Khaled Abbas, covering roles in Machine Learning, Data Engineering, Business Intelligence, and Technical Mentorship."
        path="/experience"
      />
      <Header />
